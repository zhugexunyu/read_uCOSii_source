...
;              b) Processor mode is switched to Handler mode (from Thread mode)  Thread mode->PSP
;              c) Stack is Main stack (switched from Process stack)		 Handler mode->MSP
